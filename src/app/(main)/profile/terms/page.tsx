      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        <div className="bg-vettr-card/30 border border-white/5 rounded-2xl p-6 space-y-6">
          ...
          <section className="space-y-3">
            <h2 className="text-white font-semibold text-base">1. Use of the Platform</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-white font-semibold text-base">2. Not Financial Advice</h2>
            <p className="text-gray-400 text-sm leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-white font-semibold text-base">3. Data Sources</h2>
            <p className="text-gray-400 text-sm leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-white font-semibold text-base">4. User Responsibility</h2>
            <p className="text-gray-400 text-sm leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-white font-semibold text-base">7. Account Terms</h2>
            <p className="text-gray-400 text-sm leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-white font-semibold text-base">8. Governing Law</h2>
            <p className="text-gray-400 text-sm leading-relaxed">
