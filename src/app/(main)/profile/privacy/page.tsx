  ...
  return (
    <div className="min-h-screen bg-vettr-navy">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        <div className="bg-vettr-card/30 border border-white/5 rounded-2xl p-6 space-y-6">
          <div>
          ...
          <section className="space-y-3">
            <h2 className="text-white font-semibold text-base">2. How We Use Your Information</h2>
            <p className="text-gray-400 text-sm leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-white font-semibold text-base">3. Data Storage & Security</h2>
            <p className="text-gray-400 text-sm leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-white font-semibold text-base">4. Third-Party Sharing</h2>
            <p className="text-gray-400 text-sm leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-white font-semibold text-base">5. Your Rights</h2>
            <p className="text-gray-400 text-sm leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-white font-semibold text-base">6. Cookies & Analytics</h2>
            <p className="text-gray-400 text-sm leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-white font-semibold text-base">7. Changes to This Policy</h2>
            <p className="text-gray-400 text-sm leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-white font-semibold text-base">8. Contact</h2>
            <p className="text-gray-400 text-sm leading-relaxed">
