...
export function PulseIcon({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function SettingsIcon({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M12 1v6m0 6v6m8.66-15l-5.2 3M8.54 14l-5.2 3m15.32 0l-5.2-3M8.54 10l-5.2-3" />
    </svg>
  );
}
...
// Check Circle Icon (for success toast)
...
// Alert Triangle Icon (for warning toast)
...
// Info Circle Icon (for info toast)
export function InfoCircleIcon({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
// Arrow Up Icon
export function ArrowUpIcon({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
// Arrow Down Icon
export function ArrowDownIcon({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
// More Horizontal Icon (three dots menu)
export function MoreHorizontalIcon({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
// Shield Check Icon (for no red flags empty state)
...
// Dollar Circle Icon (for financing alerts)
export function DollarCircleIcon({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
// Pickaxe Icon (for drill result alerts)
export function PickaxeIcon({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
// Trending Up Icon (chart trending up)
...
// Newspaper / News Icon
export function NewspaperIcon({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
// Link / Chain Icon (for brokerage linking)
