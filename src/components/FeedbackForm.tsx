...
export default function FeedbackForm({ isOpen, onClose }: FeedbackFormProps) {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-vettr-card border border-gray-200 dark:border-white/10 rounded-2xl w-full max-w-md shadow-2xl">
        {isSuccess ? (
          // Success State
          ...
          <>
            ...
            <div className="flex items-center justify-between px-6 pt-6 pb-0 mb-6">
              ...
              <button
                onClick={onClose}
                className="p-1 text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/5 rounded-lg transition-colors"
            ...
            <form onSubmit={handleSubmit} className="px-6 pb-6 space-y-5">
                    ...
                    <button
                      ...
                      className={`p-3 rounded-xl border transition-all text-center ${
                        category === cat.value
                          ...
                          : 'bg-gray-50 dark:bg-white/5 border-gray-200 dark:border-white/10 hover:border-gray-300 dark:hover:border-white/20 hover:bg-gray-100 dark:hover:bg-white/10'
                      }`}
                    >
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  aria-required="true"
                  className="w-full min-h-[120px] bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-2.5 text-gray-900 dark:text-white text-sm placeholder-gray-400 dark:placeholder-gray-500 focus:border-vettr-accent/40 focus:ring-1 focus:ring-vettr-accent/20 transition-all resize-none"
                  disabled={isSubmitting}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-2.5 text-gray-900 dark:text-white text-sm placeholder-gray-400 dark:placeholder-gray-500 focus:border-vettr-accent/40 focus:ring-1 focus:ring-vettr-accent/20 transition-all"
                  disabled={isSubmitting}
                />
              ...
              <div className="flex gap-3 pt-2">
                <button
                  type="button"
                  onClick={onClose}
                  className="flex-1 px-4 py-2.5 bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white rounded-xl hover:bg-gray-200 dark:hover:bg-white/10 transition-colors"
                  disabled={isSubmitting}
                >
                  Cancel
                </button>
